(function ($) {
    ...
    $.fn.colorboxNode = function (options) {
        ...
        $(this).click(function () {
            ...
            //If a ClassName exists in teh URL add it to the colorbox element
            var URIparams = $.urlParams(href);
            if(URIparams.className) {
                $('#colorbox').removeClass();
                $('#colorbox').addClass(URIparams.className);
            } else {
                $('#colorbox').removeClass();
            }
